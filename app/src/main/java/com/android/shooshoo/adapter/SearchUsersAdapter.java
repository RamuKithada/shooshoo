...
public class SearchUsersAdapter extends RecyclerView.Adapter<SearchUsersAdapter.MyViewHolder> implements Filterable
{
    ...
    public SearchUsersAdapter(Context context, ArrayList<ContactsModel> contactsModelArrayList)
    {
    ...
    @Override
    public SearchUsersAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
    {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.find_contactsmodel, parent, false);
        return new SearchUsersAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final SearchUsersAdapter.MyViewHolder holder, final int position)
    {
        final SearchUsersAdapter.MyViewHolder myViewHolder=holder;
